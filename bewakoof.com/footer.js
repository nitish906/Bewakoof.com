var footer = () => {
    return `
    <main id="footer1">
          <div class="icon">Bewakoof <span>&reg;</span></div>
          <section class="footer1-0">
            ...
            <ul class="footer1-0-div">
              <p class="footer1-0-title">COMPANY</p>
              <li>About Us</li>
              <li>We Are Hiring</li>
            ...
            <ul class="footer1-0-div">
              ...
              <li>
                <i class="fa-brands fa-facebook-square"></i>&nbsp;&nbsp; 4.7M
                People Like This
              </li>
              <li>
                <i class="fa-brands fa-instagram"></i>&nbsp;&nbsp; 1M Follower
              </li>
              <li>
            ...
            <ul class="footer1-0-div">
              <p class="footer1-0-title">KEEP UP TO DATE</p>
              <form>
                <input type="text" placeholder="Enter Email Id" id="search" />
          ...
          <section class="footer1-0">
            ...
            <ul class="footer1-0-div2">
              <p class="footer1-0-title">DOWNLOAD THE APP</p>
              <img
            ...
            <ul class="footer1-0-div2">
              <p class="footer1-0-title">100% SECURE PAYMENT</p>
              <img
        ...
        <main id="footer2">
          <ul class="footer2-div">
            <p class="footer2-div-title">MEN'S CLOTHING</p>
            <li class="footer2-div-subTitle">Top Wear</li>
            ...
            <li class="footer2-div-subTitle">Bottom Wear</li>
            <li>Men's Pajamas</li>
            ...
            <li class="footer2-div-subTitle">Featured</li>
          ...
          <ul class="footer2-div">
            <p class="footer2-div-title">WOMEN'S CLOTHING</p>
            <li class="footer2-div-subTitle">Women's Top Wear</li>
            ...
            <li class="footer2-div-subTitle">Women's Bottom Wear</li>
            ...
            <li class="footer2-div-subTitle">Bags</li>
            <li>Laptop Bags</li>
          ...
          <ul class="footer2-div">
            <p class="footer2-div-title">MOBILE COVERS</p>
            <li class="footer2-div-subTitle">Brands</li>
            <li>Apple</li>
            <li>Realme</li>
            <li>Samsung</li>
            <li>Xiaomi</li>
          ...
          <ul class="footer2-div">
            <p class="footer2-div-title-2">FANBOOK</p>
            <p class="footer2-div-title-2">OFFER</p>
            <p class="footer2-div-title-2">SITE MAP</p>
          </ul>
        </main>
